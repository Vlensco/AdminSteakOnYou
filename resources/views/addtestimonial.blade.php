                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form action="/savetestimonial" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 mt-4">
                                                <input required type="number" name="bintang" pattern="[1-5]" class="form-control"
                                                    placeholder="Bintang">
                                            </div>
                                        </div>
                                        <a href="/testimonial" class="btn btn-primary mt-4" >Back</a>
