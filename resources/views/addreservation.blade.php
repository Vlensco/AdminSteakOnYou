            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Add Reservation</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form action="/savereservation" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                        <div class="row">
                                            <div class="col-12 mt-4">
                                                <input required type="text" name="nama" class="form-control"
                                                    placeholder="Nama Orang Reservasi">
                                            </div>
                                            <div class="col-12 mt-4">
                                        ...
                                        <a href="/reservation" class="btn btn-primary mt-4" >Back</a>
